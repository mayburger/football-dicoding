package com.mayburger.football.mvp.search.events
...
class SearchEventsAdapter(var list: List<Search.Event> = arrayListOf(), var ctx: Context, var repo: SoccerRepository, private val listener: (Search.Event) -> Unit) : BaseRecyclerAdapter<SearchEventsAdapter.TeamsViewHolder>() {
